...
bool DoCanonicalizeFileSystemURL(const CHAR* spec,
  ...
  if (CompareSchemeComponent(spec, inner_parsed->scheme, uri::kFileScheme)) {
    ...
    success = CanonicalizeStandardURL(spec, inner_parsed->Length(), *inner_parsed, inner_scheme_type, charset_converter,
...
bool CanonicalizeFileSystemURL(const char* spec,
                               ...
                               CanonOutput* output,
                               Parsed* new_parsed) {
  return DoCanonicalizeFileSystemURL<char, unsigned char>(spec, URLComponentSource<char>(spec), parsed,
...
bool CanonicalizeFileSystemURL(const char16* spec,
                               ...
                               CanonOutput* output,
                               Parsed* new_parsed) {
  return DoCanonicalizeFileSystemURL<char16, char16>(spec, URLComponentSource<char16>(spec), parsed, charset_converter,
                                                     output, new_parsed);
}
