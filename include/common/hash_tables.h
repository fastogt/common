...
#define DEFINE_TRIVIAL_HASH(integral_type)                                                        \
  ...
  struct hash<integral_type> {                                                                    \
    std::size_t operator()(integral_type value) const { return static_cast<std::size_t>(value); } \
  }
...
inline std::size_t HashInts32(uint32_t value1, uint32_t value2) {
  ...
  std::size_t high_bits = static_cast<std::size_t>(hash64 >> (8 * (sizeof(uint64_t) - sizeof(std::size_t))));
  return high_bits;
}
...
#define DEFINE_32BIT_PAIR_HASH(Type1, Type2) \
  inline std::size_t HashPair(Type1 value1, Type2 value2) { return HashInts32(value1, value2); }
...
#define DEFINE_64BIT_PAIR_HASH(Type1, Type2) \
  inline std::size_t HashPair(Type1 value1, Type2 value2) { return HashInts64(value1, value2); }
...
struct hash<std::pair<Type1, Type2> > {
  std::size_t operator()(std::pair<Type1, Type2> value) const { return base::HashPair(value.first, value.second); }
};
